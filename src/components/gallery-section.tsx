    ...
    <section ref={setSortRef} style={style} className="flex flex-col gap-4">
      ...
      >
        <div
          ...
          className={
            "reorder-grid grid grid-cols-1 gap-3 md:grid-cols-12 md:auto-rows-[80px] md:grid-flow-row-dense " +
            (droppable.isOver
...
export function VisitorGallerySection({
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-12 md:auto-rows-[80px] md:grid-flow-row-dense">
